require "/items/active/weapons/ranged/lminerbeamfire.lua"
...
function minerbeamfire:cooldown()
  ...
  util.wait(self.stances.cooldown.duration, function()
	...
	local distance = vec2.mag(world.distance(aimPosition, beamStart))
	local range = util.clamp(distance,0,self.beamLength)
...
function minerbeamfire:beamFrame()
