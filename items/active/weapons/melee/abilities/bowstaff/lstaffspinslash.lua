...
LStaffSpinSlash = WeaponAbility:new()

function LStaffSpinSlash:init()
  self.cooldownTimer = self.cooldownTime
  self.chargeTimer = 0
  self.queryDamageSince = 0
end

function LStaffSpinSlash:update(dt, fireMode, shiftHeld)
...
function LStaffSpinSlash:windup()
...
function LStaffSpinSlash:flip(chargePercentage, fromJump)
...
function LStaffSpinSlash:launch()
...
function LStaffSpinSlash:uninit()
  status.clearPersistentEffects("weaponMovementAbility")
  animator.setAnimationState("swoosh", "idle")
  mcontroller.setRotation(0)
  animator.setParticleEmitterActive("flip", false)
