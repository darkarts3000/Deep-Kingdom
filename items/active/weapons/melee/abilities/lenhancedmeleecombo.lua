...
LEnhancedMeleeCombo = WeaponAbility:new()

function LEnhancedMeleeCombo:init()
  self.comboStep = 1
  self.airTime = 0
...
function LEnhancedMeleeCombo:update(dt, fireMode, shiftHeld)
...
function LEnhancedMeleeCombo:windup()
...
function LEnhancedMeleeCombo:wait()
...
function LEnhancedMeleeCombo:preslash()
...
-- State: fire
function LEnhancedMeleeCombo:fire()
...
function LEnhancedMeleeCombo:shouldActivate()
...
function LEnhancedMeleeCombo:readyFlash()
  animator.setGlobalTag("bladeDirectives", self.flashDirectives)
  self.flashTimer = self.flashTime
end

function LEnhancedMeleeCombo:animatedFlash(flashTime, flashDirectives)
  animator.setGlobalTag("bladeDirectives", flashDirectives)
  self.flashTimer = flashTime or self.flashTime
end

function LEnhancedMeleeCombo:computeDamageAndCooldowns()
  local attackTimes = {}
...
function LEnhancedMeleeCombo:aimVector(inaccuracy)
  local aimVector = vec2.rotate({1, 0}, self.weapon.aimAngle + sb.nrand(inaccuracy, 0))
  aimVector[1] = aimVector[1] * mcontroller.facingDirection()
  return aimVector
end

function LEnhancedMeleeCombo:uninit()
